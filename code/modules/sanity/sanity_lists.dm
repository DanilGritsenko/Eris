...
/datum/sanity/proc/pick_quote_40()
	var/static/list/sanity_quotes_40 = list(
		...
		"Cuts run deep in your mind. Your willpower leaks through wounds.",
...
/datum/sanity/proc/pick_quote_20()
	...
	if(!sanity_quotes_20)
		sanity_quotes_20 = list(
			...
			"At the verge of your willpower, gasping for sense, you are visited by an extreme thought - what if all of this could have been avoided if you were kinder to those around you?",
			"ALL IS FINE",
